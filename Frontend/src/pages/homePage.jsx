              ...
              <Col md={6}>
                <div style={{ marginTop: "-25px" }}>
                  <h4 className="fw-bold mb-4">
                    {" "}
                    We Provide the Most Valuable Learning Experience That
                    Inspires Growth.
                  </h4>
                  <h4 className="fw-bold  mb-4">
                  ...
                  <ul>
                    <li>
                      ✔ Every effort is meaningful when it leads to real
                      progress.
                    </li>
                    <li>
                      ✔ Challenges may seem burdensome, but they pave the way
                      for success.
                    </li>
                    <li>
                      ✔ We offer hands-on learning experiences that open doors
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      aliqua. Tenetur quia eos. Autem tempore quibusdam vel
